...
const { Client } = pg;
const connectionString = process.env.DATABASE_URL || 'postgresql://postgres:Mutebites%40135@db.pxtizpwijvjzsmripmxy.supabase.co:5432/postgres';
...
async function initSupabase() {
  ...
  try {
    console.log('Connecting to Supabase PostgreSQL at db.pxtizpwijvjzsmripmxy.supabase.co...');
